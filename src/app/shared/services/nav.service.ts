...
export class NavService {
  ...
  MENUITEMS: Menu[] = [
    ...
    {
      path: '/admin/tickets', title: 'Tickets', icon: 'list', type: 'link', active: false
    },
    {
      path: '/admin/projects', title: 'Projects', icon: 'code', type: 'link', active: false
    },
    {
      title: 'Settings', icon: 'settings', type: 'sub', children: [
        { path: '/admin/settings', title: 'Settings', type: 'link' },
        { path: '/admin/settings/profile', title: 'Profile', type: 'link' },
      ]
    },
    // {
    ...
    // },
    // {
    //   title: 'Login', path: '/login', icon: 'log-in', type: 'link', active: false
    // }
  ]
  // Array
